...
//     const { p_name, health_issue, hospital_name, city,goal_amount } = patientdata;
//     const user ={ p_name, health_issue, hospital_name, city,goal_amount }
//     console.log(patientdata);
//     axios.post('http://localhost:4000/patient',user )
...
//     <label for="inputEmail3" className="col-sm-4 col-form-label">Patient full Name</label>
//     <div class="col-sm-8">
//     <input type="file" className="form-control next" id="" placeholder="Choose Files" value={patient_data.photos} name='photos' onChange={inputfun('goal_amount')}/>
